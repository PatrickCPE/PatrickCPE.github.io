...
category: tutorials
description: "Cheatsheet for my workflow in Altium's layout tool"
...
* Spend time making the rat's nest of traces as short as possible. Rotate parts around, and make sure there is as short of a distance as possible for you to route wires.  
...
* If you need to use vias use them, there are different theories on what's best here. Some people prefer routing all on the top layer, some believe hiding the signals in your stack up is more beneficial.  
...
Click the PDF Container and add your PDFs to it, adjust this output structure as well.
